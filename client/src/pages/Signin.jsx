  ...
  return (
    <div className="flex justify-center items-center min-h-screen w-full bg-gradient-to-br from-purple-100 to-white">
      <div className="bg-white text-black p-8 rounded-lg shadow-2xl w-[30%]">
        <h2 className="text-2xl font-semibold text-center mb-6 text-purple-800">Sign In</h2>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="text-center text-sm text-gray-700">Don't have an account? <a href="/signup" className="text-purple-600 underline">Sign Up</a></div>
